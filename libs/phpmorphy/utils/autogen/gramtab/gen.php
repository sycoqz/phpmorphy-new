...
class phpMorphy_GramTab_Consts_Generator
{
     ...
     * @throws Exception
     */
    private function doGenerate($outFile): void
    {
    ...
    private function writeConsts($fh, GramTabConstHelperInterface $helper)
    {
    ...
    protected function generateConsts(GramTabConstHelperInterface $helper, $method): string
    {
        $result = [];
    ...
    private function generateConst($id, $name): string
    {
