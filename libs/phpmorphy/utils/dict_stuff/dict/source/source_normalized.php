...
class phpMorphy_Dict_FlexiaModel_Normalized extends phpMorphy_Dict_FlexiaModel_Decorator
{
    ...
    public function __decorate(phpMorphy_Dict_Flexia_Interface $flexia)
    {
...
class phpMorphy_Dict_Source_Normalized_Ancodes_Manager
{
    ...
    private $grammems_map = [];

    private $ancodes = [];

    private $helper;

    public function __construct(phpMorphy_Dict_Source_Interface $source)
    {
...
class phpMorphy_Dict_Source_Normalized_Ancodes extends phpMorphy_Dict_Source_Normalized_Decorator
{
    ...
    public static function wrap(phpMorphy_Dict_Source_Interface $source)
    {
        $self = __CLASS__;
    ...
    public function __construct(phpMorphy_Dict_Source_Interface $inner)
    {
        parent::__construct($inner);
