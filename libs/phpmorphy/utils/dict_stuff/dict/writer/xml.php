...
class phpMorphy_Dict_Writer_Xml extends phpMorphy_Dict_Writer_Base
{
    ...
    public function write(DictSourceInterface $source): void
    {
    ...
    private function writeOptions(XMLWriter $writer, DictSourceInterface $source): void
    {
        $this->log(__METHOD__);
    ...
    private function writeLemmas(XMLWriter $writer, $it): void
    {
        $this->log(__METHOD__);
    ...
    private function getXmlOptions(): array
    {
        return [
            'xml_version' => '1.0',
            'xml_encoding' => 'utf-8',
    ...
    private function createXmlWriter($fileName): XMLWriter
    {
        $writer = new XMLWriter;

        if ($writer->openUri($fileName) === false) {
