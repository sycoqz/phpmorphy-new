...
abstract class phpMorphy_Mrd_Section implements Countable, Iterator
{
...
class phpMorphy_Mrd_Section_Lemmas extends phpMorphy_Mrd_Section
{
    protected function processLine($line)
    {
        ...
        if (count($tokens = explode(' ', $line)) != 6) {
