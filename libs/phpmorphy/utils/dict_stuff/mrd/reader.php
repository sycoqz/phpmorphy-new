...
class phpMorphy_Mrd_Section_Lemmas extends phpMorphy_Mrd_Section {
     ...
     * @throws Exception
     */
    protected function processLine($line): phpMorphy_Dict_Lemma
    {
...
class phpMorphy_Mrd_File {
     ...
     * @throws phpMorphy_Mrd_Exception
     */
    function __construct(string $fileName, $encoding) {
		$line = 0;
     ...
     * @throws phpMorphy_Mrd_Exception
     */
    protected function initSections(&$startLine, $fileName, $encoding): void
    {
	...
	protected function getSectionsNames(): array
    {
		return array(
			'flexias',
			'accents',
	...
	protected function openFile($fileName): SplFileObject
    {
		return new SplFileObject($fileName);
	}

	protected function getSectionClassName($sectionName): string
    {
