...
class phpMorphy_Graminfo_File extends phpMorphy_Graminfo {
    public function getGramInfoHeaderSize(): int
    {
        return 20;
    }
    ...
    protected function readAncodesMap($info): bool|array
    {
        $__fh = $this->resource;
    ...
    protected function splitAncodes($ancodes, $map): array
    {
        $result = [];
    ...
    public function readFlexiaData(array $info): array
    {
        ...
        $offset += $info['affixes_offset'] ?? $info['forms_count'] * 2 + $info['packed_forms_count'] * 2;
    ...
    protected function readSectionIndex($offset, $count): bool|array
    {
        $__fh = $this->resource;
    ...
    public function readAllFlexia(): array
    {
        $__fh = $this->resource;
    ...
    public function readAllPartOfSpeech(): array
    {
        $__fh = $this->resource;
    ...
    public function readAllGrammems(): array
    {
        $__fh = $this->resource;
    ...
    public function readAllAncodes(): array
    {
        $__fh = $this->resource;
