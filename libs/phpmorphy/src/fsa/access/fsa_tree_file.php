...
class phpMorphy_Fsa_Tree_File extends phpMorphy_Fsa {
    public function walk($trans, string $word, bool $readAnnot = true): bool|array
    {
    ...
    public function unpackTranses(array $rawTranses): array
    {
        ...
        foreach($rawTranses as $rawTrans) {
            $result[] = array(
				...
				'llast' => (bool)(($rawTrans & 0x0200)),
				'rlast' => (bool)(($rawTrans & 0x0400)),
				'attr'  => ($rawTrans & 0xFF),
    ...
    public function getAnnot(array|int $trans): bool|string|null
    {
        if(!($trans & 0x0100)) {
            return null;
        }
