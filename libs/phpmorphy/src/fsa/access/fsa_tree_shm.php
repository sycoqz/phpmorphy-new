...
class phpMorphy_Fsa_Tree_Shm extends phpMorphy_Fsa {
    public function walk(mixed $trans, string $word, bool $readAnnot = true) {
    ...
    public function readState(int $index) {
        $__shm = $this->resource['shm_id']; $__offset = $this->resource['offset']; $fsa_start = $this->fsa_start;
    ...
    public function unpackTranses(mixed $rawTranses) {
    ...
    public function getAnnot(array $trans) {
        if(!($trans & 0x0100)) {
            return null;
        }
