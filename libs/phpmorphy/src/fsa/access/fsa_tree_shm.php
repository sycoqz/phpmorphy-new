...
class phpMorphy_Fsa_Tree_Shm extends phpMorphy_Fsa
{
    public function walk($trans, $word, $readAnnot = true)
    {
        ...
        for ($i = 0, $c = $GLOBALS['__phpmorphy_strlen']($word); $i < $c; $i++) {
            ...
            if ($result) {
                ...
                for ($idx = 1, $j = 0; ; $j++) {
                    ...
                    [, $trans] = unpack('V', shmop_read($__shm, $__offset + ($start_offset + (($idx - 1) << 2)), 4));
                }
            }
        ...
        if ($i >= $c) {
            ...
            if ($readAnnot) {
                ...
                [, $trans] = unpack('V', shmop_read($__shm, $__offset + ($fsa_start + ((($trans >> 11) & 0x1FFFFF) << 2)), 4));
    ...
    public function readState($index)
    {
        ...
        [, $trans] = unpack('V', shmop_read($__shm, $__offset + ($offset), 4));
    ...
    protected function readRootTrans()
    {
        ...
        [, $trans] = unpack('V', shmop_read($__shm, $__offset + ($fsa_start + 0), 4));
