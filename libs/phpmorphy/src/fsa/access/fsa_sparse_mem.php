...
class phpMorphy_Fsa_Sparse_Mem extends phpMorphy_Fsa
{
    public function walk($trans, $word, $readAnnot = true)
    {
        ...
        for ($i = 0, $c = $GLOBALS['__phpmorphy_strlen']($word); $i < $c; $i++) {
            ...
            [, $trans] = unpack('V', $GLOBALS['__phpmorphy_substr']($__mem, $fsa_start + (((($trans >> 10) & 0x3FFFFF) + $char + 1) << 2), 4));
        ...
        if ($i >= $c) {
            ...
            if ($readAnnot) {
                ...
                [, $trans] = unpack('V', $GLOBALS['__phpmorphy_substr']($__mem, $fsa_start + ((($trans >> 10) & 0x3FFFFF) << 2), 4));
    ...
    public function readState($index)
    {
        ...
        [, $trans] = unpack('V', $GLOBALS['__phpmorphy_substr']($__mem, $start_offset, 4));
        ...
        foreach ($this->getAlphabetNum() as $char) {
            ...
            [, $trans] = unpack('V', $GLOBALS['__phpmorphy_substr']($__mem, $start_offset + (($char) << 2), 4));
    ...
    protected function readRootTrans()
    {
        ...
        [, $trans] = unpack('V', $GLOBALS['__phpmorphy_substr']($__mem, $fsa_start + 4, 4));
