...
class phpMorphy
{
    ...
    protected string $last_prediction_type;
    ...
    public function getCommonMorphier(): MorphierInterface
    {
        return $this->__common_morphier;
    }

    public function getPredictBySuffixMorphier(): MorphierInterface
    {
        return $this->__predict_by_suf_morphier;
    }

    public function getPredictByDatabaseMorphier(): MorphierInterface
    {
     ...
     * @param  int  $type  - prediction management
     */
    public function findWord(array|string $word, int $type = self::NORMAL): bool|array|phpMorphy_WordDescriptor_Collection
    {
        if (is_array($word)) {
            $result = [];
     ...
     * @param  int  $type  - prediction management
     */
    public function lemmatize(array|string $word, int $type = self::NORMAL): bool|array
    {
     ...
     * @param  int  $type  - prediction management
     */
    public function getBaseForm(array|string $word, int $type = self::NORMAL): bool|array
    {
     ...
     * @param  int  $type  - prediction management
     */
    public function getAllForms(array|string $word, int $type = self::NORMAL): bool|array
    {
     ...
     * @param  int  $type  - prediction management
     */
    public function getPseudoRoot(array|string $word, int $type = self::NORMAL): bool|array
    {
     ...
     * @param  int  $type  - prediction management
     */
    public function getPartOfSpeech(array|string $word, int $type = self::NORMAL): bool|array
    {
     ...
     * @param  mixed  $type
     */
    public function castFormByPattern(string $word, string $patternWord, ?GrammemsProviderInterface $grammemsProvider = null, bool $returnOnlyWord = false, $callback = null, $type = self::NORMAL): bool|array
    {
     ...
     * @throws phpMorphy_Exception
     */
    protected function createAncodesResolverInternal(GramTabInterface $gramtab, phpMorphy_FilesBundle $bundle): array
    {
     ...
     * @throws phpMorphy_Exception
     */
    protected function createAncodesResolver(GramTabInterface $gramtab, phpMorphy_FilesBundle $bundle, $lazy)
    {
    ...
    protected function createMorphierHelper(
        GramInfoInterface $graminfo,
        GramTabInterface $gramtab,
        $graminfoAsText,
    ...
    protected function createCommonMorphier(FsaInterface $fsa, phpMorphy_Morphier_Helper $helper): phpMorphy_Morphier_Common
    {
        return new phpMorphy_Morphier_Common($fsa, $helper);
    }

    protected function createBulkMorphier(FsaInterface $fsa, phpMorphy_Morphier_Helper $helper): phpMorphy_Morphier_Bulk
    {
        return new phpMorphy_Morphier_Bulk($fsa, $helper);
    }

    protected function createPredictByDbMorphier(FsaInterface $fsa, phpMorphy_Morphier_Helper $helper): phpMorphy_Morphier_Empty|phpMorphy_Morphier_Predict_Database
    {
    ...
    protected function createPredictBySuffixMorphier(FsaInterface $fsa, phpMorphy_Morphier_Helper $helper): phpMorphy_Morphier_Predict_Suffix|phpMorphy_Morphier_Empty
    {
